...
const initPayload: ResetPasswordPayload = {
  passwordReset: "",
  confirmPassword: ""
}
...
const ResetPassword = ({ searchParams }: { searchParams: SearchParams }) => {
  ...
  const [payload, setPayload] = useState<ResetPasswordPayload>(initPayload);
        ...
        <div className="flex flex-wrap items-center">
          ...
          <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              ...
              <p className="text-meta-5 text-3xl">Hi {JSON.stringify(searchParams?.email)}</p>
              ...
              <form onSubmit={(e) => handleResetPassword(e)}>
                <div className="mb-4">
                  ...
                  <p className="text-meta-1">{errors?.passwordReset}</p>
                  <div className="relative">
                    <input
                      onChange={(e) => setPayload({...payload, passwordReset: e.target.value})}
                      value={payload.passwordReset}
                      type="password"
                ...
                <div className="mb-4">
                  ...
                  <p className="text-meta-1">{errors?.confirmPassword}</p>
                  <div className="relative">
                    <input
